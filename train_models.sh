...
cd tmp
echo package com.baldrichcorp.ml.generated\; | cat - RFIrisPredictor.java > tmp.java
...
r -f iris_gbm.R
cd tmp
echo package com.baldrichcorp.ml.generated\; | cat - GBMIrisPredictor.java > tmp.java
